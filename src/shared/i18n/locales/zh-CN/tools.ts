export default {
  ...
  openclaw: { label: "OpenClaw 技能", description: "通过 OpenClaw 网关（端口 18791）执行技能" },
  clawmem: { label: "ClawMem 记忆", description: "通过 ClawMem（端口 7438）实现持久代理记忆" },
  voice: { label: "语音回路", description: "Whisper 语音识别 → LLM → VibeVoice 语音合成管道" },
  mcpServers: "MCP 服务器",
