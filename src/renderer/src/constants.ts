...
export const PROVIDERS = {
  options: [
    ...
    { value: "goclaw", label: "constants.goclawName" },
    { value: "ollama-launch", label: "constants.ollamaLaunchName" },
    ...
    { value: "deepseek", label: "constants.deepseekName" },
    { value: "groq", label: "constants.groqName" },
    { value: "minimax", label: "MiniMax" },
    { value: "custom", label: "Local / Custom" },
  ],

  labels: {
    goclaw: "constants.goclawName",
    "ollama-launch": "constants.ollamaLaunchName",
  ...
  setup: [
    {
      id: "goclaw",
      name: "constants.goclawName",
      desc: "constants.goclawDesc",
      tag: "NovaMaster",
      envKey: "GOCLAW_API_KEY",
      url: "http://127.0.0.1:18790",
      placeholder: "optional",
      configProvider: "goclaw",
      baseUrl: "http://127.0.0.1:18790/v1",
      needsKey: false,
    },
    {
      id: "ollama-launch",
      name: "constants.ollamaLaunchName",
      desc: "constants.ollamaLaunchDesc",
      tag: "Local",
      envKey: "",
      url: "http://127.0.0.1:11434",
      placeholder: "",
      configProvider: "ollama-launch",
    ...
    {
      id: "groq",
      name: "constants.groqName",
      desc: "constants.groqDesc",
      tag: "",
      envKey: "GROQ_API_KEY",
...
export const SETTINGS_SECTIONS: SectionDef[] = [
  ...
  {
    title: "constants.sectionNovaMaster",
    items: [
      {
        key: "GOCLAW_API_KEY",
        label: "constants.goclawApiKey",
        type: "password",
        hint: "constants.goclawHint",
      },
      {
        key: "OPENCLAW_API_KEY",
        label: "constants.openclawApiKey",
        type: "password",
        hint: "constants.openclawHint",
      },
      {
        key: "CLAWMEM_API_KEY",
        label: "constants.clawmemApiKey",
        type: "password",
        hint: "constants.clawmemHint",
      },
    ],
  },
  {
